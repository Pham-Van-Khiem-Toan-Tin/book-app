...
public class SalePublisherController implements Initializable {
    @FXML
    ...
    @FXML
    private Button btnSearch, btnUser, btnSaleBook, btnSaleCategory, btnSalePublisher, btnSaleCustomer, btnSaleEmployee;
    ...
    private void changeDataChart() {
        ...
        List<SaleEntity> revenueList = dao.getAllRevenueOfPublisher(statisticsFollow.getValue(), null, null);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        UIUtils.setupMenuEmployee(btnUser, btnSaleBook, btnSaleCategory, btnSalePublisher, btnSaleCustomer, btnSaleEmployee);
