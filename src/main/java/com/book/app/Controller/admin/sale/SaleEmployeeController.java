...
public class SaleEmployeeController implements Initializable {
    @FXML
    ...
    @FXML
    private Button btnSearch, btnUser, btnSaleBook, btnSaleCategory, btnSalePublisher, btnSaleAuthor, btnSaleCustomer, btnSaleEmployee;
