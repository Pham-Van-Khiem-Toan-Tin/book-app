...
public class SaleCustomerController implements Initializable {
    @FXML
    ...
    @FXML
    private Button btnUser, btnSaleBook, btnSaleAuthor, btnSaleCategory, btnSalePublisher, btnSaleCustomer, btnSaleEmployee;
    ...
    private void changeDataChart() {
        ...
        List<SaleEntity> revenueList = dao.getAllRevenueOfEmployee(statisticsFollow.getValue(), null, null);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        UIUtils.setupMenuEmployee(btnUser, btnSaleBook, btnSaleAuthor, btnSaleCategory, btnSalePublisher, btnSaleCustomer, btnSaleEmployee);
